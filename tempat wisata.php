...
<table width="1166" height="877" border="0" align="center">
  ...
  <tr>
    ...
    <td width="225"><a href="guide.php"><img src="guide.png" width="188" height="60" onMouseOver="this.src='guide1.png'" onMouseOut="this.src='guide.png'"  /></a></td>
    <td width="214"><a href="tw.php"><img src="tw.png" width="188" height="60" onMouseOver="this.src='tw.png'" onMouseOut="this.src='tw1.png'"  /></a></td>
  ...
  <tr>
    <td colspan="4"><h2>Berikut ini adalah daftar Tempat Wisata<br/>
    Di kota sibolga.</h2></td>
  ...
  <tr>
    <td><a href="http://mikroskil.ac.id" target="_new"><img src="mursala.png" width="234" height="238" alt="1" /></a></td>
    <td colspan="2"><p align="justify"><strong>1. Mursala<br/></strong>      
      Air Terjun Mursala adalah salah satu air terjun di   Indonesia yang terjunan airnya langsung jatuh ke laut.  Air terjun ini   berada di Pulau Mursala, yang terletak diantara Pulau Sumatera dan Pulau   Nias.      <br/><br/>
   ...
   <br/> <br/>Keunikan lain Pulau Mursala adalah adanya obyek   wisata air terjun dengan ketinggian lebih kurang 35 m yang langsung   jatuh dari tebing pulau ke permukaan laut. Mungkin beberapa air terjun   yang sudah anda lihat, jatuhnya air langsung ke sungai atau danau   seperti air terjun Lembah Anai di Sumatera Barat yang berada persis   ditepi jalan raya.</p></td>
    <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="3"><p align="justify">Air terjun di Pulau Mursala berada pada bagian pulau   yang menghadap langsung ke Samudra Hindia. Air mengalir pada batuan   granit kemerah-merahan di tebing pulau, lalu tercurah dalam volume yang   besar ke permukaan laut dengan bunyi berdebum-debum. Volume air terjun   akan lebih besar lagi pada musim penghujan.</p></td>
    <td>&nbsp;</td>
    <td colspan="3">&nbsp;</td>
  </tr>
  <tr>
